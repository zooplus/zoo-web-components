(function () {
    ...
    class InputInfo extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>.info,.error{padding:0 2px 2px 0;font-size:12px;color:#555555;display:flex;align-items:center}.info.hidden,.error.hidden{display:none}.info svg path{fill:#459FD0}.error{animation:hideshow 0.5s ease;color:#ED1C24}.error svg path{fill:#ED1C24}@keyframes hideshow{0%{opacity:0}100%{opacity:1}}</style>`;
    ...
    class GridPaginator extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>.box{display:flex;justify-content:end;padding:10px 15px 10px 0;font-size:14px}.box .paging{display:flex;align-items:center;border:1px solid #97999C;border-radius:5px;margin:3px 0 3px 20px}.box .paging.hidden{opacity:0}.box .btn{display:flex;cursor:pointer;opacity:1;transition:opacity 0.1s;margin-left:10px}.box .btn:active{opacity:0.5}.box .btn.hidden{opacity:0}.box .btn.next{margin-left:5px}.box .btn.next svg{transform:rotate(-90deg)}.box .btn.prev{margin-right:10px}.box .btn.prev svg{transform:rotate(90deg)}.box svg{fill:#555555}.box .nav-arrow path{fill:var(--main-color, #3C9700)}.box .page-element{cursor:pointer}.box .page-element:hover{background:#F2F3F4}.box .page-element.active{background:#EBF4E5;color:var(--main-color, #3C9700)}.box .page-element,.box .page-element-dots{display:flex;align-items:center;justify-content:center;border-radius:3px;width:24px;height:24px;margin-right:5px}.box .page-element-dots{display:none}.box .page-element+.page-element-dots{display:flex}</style>`;
