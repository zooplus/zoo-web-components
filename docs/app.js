var app = (function () {
	...
	function create_each_block(ctx) {
		...
		return {
			c: function create() {
				...
				a.className = "svelte-1f67p52";
				add_location(a, file, 59, 6, 2618);
				div.className = "link-wrapper svelte-1f67p52";
				add_location(div, file, 58, 5, 2585);
				hr.className = "left-menu-separator svelte-1f67p52";
	...
	function create_fragment(ctx) {
		...
		return {
			c: function create() {
				...
				hr2.className = "svelte-1f67p52";
				add_location(hr2, file, 21, 3, 646);
				div0.className = "overview svelte-1f67p52";
				...
				p0.className = "ciu_embed svelte-1f67p52";
				...
				p1.className = "ciu_embed svelte-1f67p52";
				...
				p2.className = "ciu_embed svelte-1f67p52";
				...
				div4.className = "back-btn svelte-1f67p52";
				add_location(div4, file, 47, 4, 2196);
				div5.className = "mobile svelte-1f67p52";
				add_location(div5, file, 36, 3, 1739);
				div6.id = "when";
				div6.className = "caniuse svelte-1f67p52";
	...
	class App extends SvelteComponentDev {
		constructor(options) {
			super(options);
			if (!document.getElementById("svelte-1f67p52-style")) add_css();
