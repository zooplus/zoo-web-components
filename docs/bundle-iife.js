(function () {
    ...
    function create_if_block_1$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			div1 = element("div");
    			t1 = text(/*inputerrormsg*/ ctx[1]);
    			attr_dev(path, "d", "M12 15.75a1.125 1.125 0 1 1 .001 2.25A1.125 1.125 0 0 1 12 15.75H12zm.75-2.25a.75.75 0 1 1-1.5 0V5.25a.75.75 0 1 1 1.5 0v8.25zm7.205-9.455l.53-.53c4.687 4.686 4.687 12.284 0 16.97-4.686 4.687-12.284 4.687-16.97 0-4.687-4.686-4.687-12.284 0-16.97 4.686-4.687 12.284-4.687 16.97 0l-.53.53zm0 0l-.53.53c-4.1-4.1-10.75-4.1-14.85 0s-4.1 10.75 0 14.85 10.75 4.1 14.85 0 4.1-10.75 0-14.85l.53-.53z");
    			add_location(path, file$c, 3, 102, 215);
    			attr_dev(svg, "class", "exclamation-circle");
    			attr_dev(svg, "width", "22");
    			attr_dev(svg, "height", "22");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			add_location(svg, file$c, 3, 27, 140);
    			attr_dev(div0, "class", "svg-wrapper");
    			add_location(div0, file$c, 3, 2, 115);
    			attr_dev(div1, "class", "error-label");
    			add_location(div1, file$c, 4, 2, 632);
    			attr_dev(div2, "class", "error-holder");
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*inputerrormsg*/ 2) set_data_dev(t1, /*inputerrormsg*/ ctx[1]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div2);
    		}
    ...
    function create_if_block$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(svg, "class", "info-rounded-circle");
    			attr_dev(svg, "width", "22");
    			attr_dev(svg, "height", "22");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*infotext*/ 4) set_data_dev(t1, /*infotext*/ ctx[2]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    		}
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (!/*valid*/ ctx[0] && /*inputerrormsg*/ ctx[1]) {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);
    				} else {
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ valid, inputerrormsg, infotext });
    ...
    class Navigation extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>.box{height:56px;background-image:linear-gradient(left, var(--main-color, #3C9700), var(--main-color-light, #66B100));background-image:-webkit-linear-gradient(left, var(--main-color, #3C9700), var(--main-color-light, #66B100))}::slotted(*:first-child){display:flex;flex-direction:row;height:100%;overflow:auto;overflow-y:hidden;padding:0 20px}</style>`;
    ...
    class CollapsableList extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>.item ::slotted(*){display:none}.item.active ::slotted(*){display:initial}ul{padding:0}.item{position:relative;color:#767676;list-style-type:none;padding:0 10px;border:0px solid black}.item .header{display:flex;align-items:center;height:8px;padding:20px 0;font-size:14px;line-height:20px;color:var(--main-color, #3C9700);font-weight:bold;cursor:pointer}.item .header svg{display:flex;margin-left:auto;fill:var(--main-color, #3C9700);transition:transform 0.3s}.item.active{border:1px solid rgba(0, 0, 0, 0.2)}.item.active .header{color:var(--main-color-dark, #286400)}.item.active .header svg{fill:var(--main-color-dark, #286400);transform:rotateX(180deg)}</style>`;
    ...
    class Spinner extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>.spinner{position:absolute;left:0;top:0;right:0;bottom:0;height:150px;width:150px;margin:auto;transform-origin:center center;animation:rotate 2s linear infinite}.spinner .path{animation:dash 1.5s ease-in-out infinite;stroke:var(--main-color, #3C9700);stroke-dasharray:1, 200;stroke-dashoffset:0;stroke-linecap:round}@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1, 200;stroke-dashoffset:0}50%{stroke-dasharray:89, 200;stroke-dashoffset:-35px}100%{stroke-dasharray:89, 200;stroke-dashoffset:-124px}}</style>`;
    ...
    function create_if_block$9(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(5:1) {#if currentpage && maxpages}",
    		ctx
    	});
    ...
    function create_fragment$m(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$m, 7, 1, 326);
    			attr_dev(path, "d", "M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z");
    			add_location(path, file$m, 9, 68, 550);
    			attr_dev(svg, "class", "nav-arrow");
    			attr_dev(svg, "width", "28");
    			attr_dev(svg, "height", "28");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			add_location(svg, file$m, 9, 2, 484);
    			attr_dev(template, "id", "arrow");
    			add_location(template, file$m, 8, 1, 460);
    ...
    function instance$m($$self, $$props, $$invalidate) {
    	...
    	const click_handler_1 = () => goToNextPage();
    ...
    class GridPaginator extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>.box{display:flex;justify-content:end;align-items:center;padding:10px 15px 10px 0}.box .btn{display:flex;cursor:pointer;opacity:1;transition:opacity 0.1s;margin-left:10px}.box .btn:active{opacity:0.5}.box .btn.hidden{opacity:0}.box .next svg{transform:rotate(-90deg)}.box .prev svg{transform:rotate(90deg)}.box svg{fill:#555555}.box .nav-arrow path{fill:var(--main-color, #3C9700)}</style>`;
