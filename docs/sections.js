    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			zoo_button0 = element("zoo-button");
    			span2 = element("span");
    			span2.textContent = "Summon toast!";
    			t12 = space();
    			zoo_button1 = element("zoo-button");
    			div2 = element("div");
    			t13 = text("Disabled :(\n\t\t\t");
    			...
    			span4 = element("span");
    			span4.textContent = "Dummy button that does nothing";
    			t18 = space();
    			...
    			attr_dev(span0, "slot", "header");
    			add_location(span0, file$3, 7, 2, 342);
    			attr_dev(div0, "slot", "content");
    			add_location(div0, file$3, 8, 2, 379);
    			set_custom_element_data(zoo_collapsable_list_item0, "slot", "item");
    			add_location(zoo_collapsable_list_item0, file$3, 6, 1, 300);
    			attr_dev(span1, "slot", "header");
    			add_location(span1, file$3, 11, 2, 486);
    			attr_dev(div1, "slot", "content");
    			add_location(div1, file$3, 12, 2, 523);
    			set_custom_element_data(zoo_collapsable_list_item1, "slot", "item");
    			add_location(zoo_collapsable_list_item1, file$3, 10, 1, 444);
    			add_location(zoo_collapsable_list, file$3, 5, 0, 276);
    			attr_dev(span2, "slot", "buttoncontent");
    			add_location(span2, file$3, 18, 2, 695);
    			set_custom_element_data(zoo_button0, "size", "small");
    			add_location(zoo_button0, file$3, 17, 1, 635);
    			...
    			add_location(zoo_tooltip, file$3, 23, 3, 870);
    			attr_dev(div2, "slot", "buttoncontent");
    			add_location(div2, file$3, 21, 2, 825);
    			...
    			add_location(zoo_button1, file$3, 20, 1, 759);
    			attr_dev(span3, "slot", "buttoncontent");
    			add_location(span3, file$3, 27, 2, 1074);
    			set_custom_element_data(zoo_button2, "type", "secondary");
    			set_custom_element_data(zoo_button2, "size", "small");
    			add_location(zoo_button2, file$3, 26, 1, 992);
    			attr_dev(span4, "slot", "buttoncontent");
    			add_location(span4, file$3, 30, 2, 1177);
    			set_custom_element_data(zoo_button3, "type", "hollow");
    			set_custom_element_data(zoo_button3, "size", "small");
    			add_location(zoo_button3, file$3, 29, 1, 1135);
    			...
    			add_location(path2, file$3, 36, 124, 2517);
    			...
    			add_location(svg1, file$3, 36, 2, 2395);
    			...
    			add_location(zoo_button5, file$3, 35, 1, 2333);
    			attr_dev(div3, "class", "buttons");
    			add_location(div3, file$3, 16, 0, 612);
    			...
    			add_location(zoo_feedback, file$3, 41, 2, 2861);
    			add_location(br0, file$3, 45, 2, 3043);
    			attr_dev(option0, "class", "placeholder");
    			option0.__value = "";
    			option0.value = option0.__value;
    			option0.disabled = true;
    			option0.selected = true;
    			add_location(option0, file$3, 49, 4, 3151);
    			option1.__value = "Doge";
    			option1.value = option1.__value;
    			add_location(option1, file$3, 50, 4, 3224);
    			option2.__value = "Catz";
    			option2.value = option2.__value;
    			add_location(option2, file$3, 51, 4, 3250);
    			option3.__value = "Snek";
    			option3.value = option3.__value;
    			add_location(option3, file$3, 52, 4, 3276);
    			attr_dev(select, "slot", "selectelement");
    			add_location(select, file$3, 48, 3, 3117);
    			...
    			add_location(zoo_select, file$3, 46, 2, 3050);
    			add_location(br1, file$3, 55, 2, 3329);
    			attr_dev(input, "slot", "checkboxelement");
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file$3, 58, 3, 3448);
    			...
    			add_location(zoo_checkbox, file$3, 56, 2, 3336);
    			add_location(br2, file$3, 60, 2, 3516);
    			attr_dev(span5, "slot", "buttoncontent");
    			add_location(span5, file$3, 62, 3, 3622);
    			...
    			add_location(zoo_button6, file$3, 61, 2, 3523);
    			add_location(div4, file$3, 40, 1, 2853);
    			set_style(zoo_modal, "display", "none");
    			set_custom_element_data(zoo_modal, "headertext", "Your basket contains licensed items");
    			add_location(zoo_modal, file$3, 39, 0, 2751);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, zoo_collapsable_list, anchor);
    			append_dev(zoo_collapsable_list, zoo_collapsable_list_item0);
    			append_dev(zoo_collapsable_list_item0, span0);
    			append_dev(zoo_collapsable_list_item0, t4);
    			append_dev(zoo_collapsable_list_item0, div0);
    			append_dev(zoo_collapsable_list, t6);
    			append_dev(zoo_collapsable_list, zoo_collapsable_list_item1);
    			append_dev(zoo_collapsable_list_item1, span1);
    			append_dev(zoo_collapsable_list_item1, t8);
    			append_dev(zoo_collapsable_list_item1, div1);
    			insert_dev(target, t10, anchor);
    			insert_dev(target, div3, anchor);
    			append_dev(div3, zoo_button0);
    			append_dev(zoo_button0, span2);
    			append_dev(div3, t12);
    			append_dev(div3, zoo_button1);
    			append_dev(zoo_button1, div2);
    			append_dev(div2, t13);
    			append_dev(div2, zoo_tooltip);
    			append_dev(div3, t14);
    			append_dev(div3, zoo_button2);
    			append_dev(zoo_button2, span3);
    			append_dev(div3, t16);
    			append_dev(div3, zoo_button3);
    			append_dev(zoo_button3, span4);
    			append_dev(div3, t18);
    			append_dev(div3, zoo_button4);
    			append_dev(zoo_button4, svg0);
    			append_dev(svg0, g);
    			append_dev(g, path0);
    			append_dev(g, path1);
    			append_dev(div3, t19);
    			append_dev(div3, zoo_button5);
    			append_dev(zoo_button5, svg1);
    			append_dev(svg1, path2);
    			insert_dev(target, t20, anchor);
    			insert_dev(target, zoo_modal, anchor);
    			append_dev(zoo_modal, div4);
    			append_dev(div4, zoo_feedback);
    			append_dev(div4, t21);
    			append_dev(div4, br0);
    			append_dev(div4, t22);
    			append_dev(div4, zoo_select);
    			...
    			append_dev(div4, br1);
    			append_dev(div4, t28);
    			append_dev(div4, zoo_checkbox);
    			append_dev(zoo_checkbox, input);
    			append_dev(div4, t29);
    			append_dev(div4, br2);
    			append_dev(div4, t30);
    			append_dev(div4, zoo_button6);
    			append_dev(zoo_button6, span5);
    		...
    		d: function destroy(detaching) {
    			...
    			if (detaching) detach_dev(zoo_collapsable_list);
